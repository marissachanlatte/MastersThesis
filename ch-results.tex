...
Again, NDA and TG-NDA agree in terms of flux values up to tolerance which can be see in Figure~\ref{fig:TwoMatErr}. A similar pattern regarding the difference is observable with the lower energy groups.
